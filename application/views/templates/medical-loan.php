<?php display_header(); ?>
<div class="container">    
	<h4 class="widgettitle title-inverse bold">Medical Loan Calculator</h4>    
	<div class="pargroup">        
		<div class="row">            
			<div class="col-md-6">                 
				<div class="par">                    
...
<div class="container">  
	<div class="row">
		<div class="col-md-9">
			...
			<p style=" color: #0067b1;font-size: 25px;font-weight: bold;font-family: Oswald; line-height: 30px;">Don't let expensive medical bills destroy your finances!   If you find yourself confronted with unforeseen expenses, come to us!</p>    

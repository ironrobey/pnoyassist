<?php display_header(); ?>
<div class="container">    
	<h4 class="widgettitle title-inverse"><i class="iconsweets-calculator"></i> Home Repair Loan Calculator</h4>    
	<div class="pargroup">        
		<div class="row">            
			<div class="col-md-6">                 
				<div class="par">                    
			...
			<div class="col-md-6">                  
				<div class="par">                    
					<p>
						<a class="btn btn-success" href=""><i class="iconfa-calendar"></i> Length of loan: <strong><span id="amount5" class="color069"></span></strong></a>                    
					</p>                    
...
<div class="container">    
	...
	<ul class="list-loan">    
		<li><span class="btn btn-info"><b>1.</b></span>  By using the calculator above, let us know the amount you may need.</li>    

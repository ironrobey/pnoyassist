                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 row">
                                            <span class="btn btn-success fileinput-button">
                                                ...
                                                <span>Select file...</span>
                                                <!-- The file input field used as target for the file upload widget -->
                                                <input id="ps_soa_meta" class="upload" type="file" name="files">
                                            </span>
                                            <span class="processUpload hide"></span>
                                            <?php $ps_soa = get_usermeta($user_id, 'ps_soa'); ?>
                                            <input type="hidden" name="ps_soa_meta" class="required" value="<?php echo $ps_soa; ?>">
                                            <?php $ps_soa_url = ( $ps_soa!='' ? site_url( 'assets/uploads/'.$ps_soa ) : '' ); ?>
                                            <a href="<?php echo $ps_soa_url; ?>" class="ps_soa_meta<?php echo ( $ps_soa!='' ? '' : ' hide' ); ?>" rel="shadowbox">View Upload</a>
                                        </div>
                                    </div>
                                </div>

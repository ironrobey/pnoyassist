<?php display_header(); ?>
<div class="container">    
	<h4 class="widgettitle title-inverse"><i class="iconsweets-calculator"></i> Leisure Loan Calculator</h4>    
	<div class="pargroup">        
		<div class="row">            
			<div class="col-md-6">                 
				<div class="par">                    
...
<div class="container">    
	...
	<ul class="list-loan">    
		...
		<li><span class="btn btn-warning"><b>3.</b></span>  Build your points by providing us with your personal and social information. The more you let us know about yourself and your connections, the greater your chances of getting your loan approved expeditiously.</li>    
		...
		<li><span class="btn btn-info"><b>7.</b></span> Your leisure money will be with you in no time.</li>    
	</ul>
</div>

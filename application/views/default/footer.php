            ...
            <div class="modal-body">
            	<div class="pargroup">
            		<div class="row">
            				...
            				<div class="par">
            					<p>
            						<a class="btn btn-success" href="">
            							<i class="iconfa-money"></i> Amount of Loan Desired: <strong> &#8369; <span id="amount40" class="color069"></span></strong>
            						</a>
            					</p>
            			...
            			<div class="col-md-12">
            				<p  class="color069" style="padding:0 10px;">Monthly Business Loan Payment: <span style="color: #0067b1">&#8369;</span> <span id="monthlypaymentModal" class="color069"></span></p>
            			</div>
            		</div>
            	</div>
            </div>

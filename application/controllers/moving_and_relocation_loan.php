...
class Moving_and_relocation_loan extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->data['headerData']['pageTitle'] = 'Pinoy Assist - Moving And Relocation Loan';
        $this->data['pageData'][] = null;

        $this->data['pageView'] = 'moving-and-relocation-loan';
